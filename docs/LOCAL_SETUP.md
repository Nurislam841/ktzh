...
Node.js 24.x для этого проекта не используй. На frontend с Next.js 14 он может давать битую `.next` сборку и ошибки вроде отсутствующего `middleware-manifest.json`.
